  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-dcl-shadow/80 via-dcl-purple/80 to-dcl-lavender/80"></div>
      </div>
      
      {/* Floating Elements inspired by Decentraland */}
      <div className="absolute inset-0 opacity-20 z-10">
        <div className="absolute top-20 left-10 w-72 h-72 bg-dcl-ruby rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-dcl-orange rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-dcl-yellow rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000"></div>
      </div>
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in mb-12">
          ...
          <Button 
            variant="outline" 
            size="lg"
            className="border-2 border-dcl-ruby/50 text-dcl-ruby hover:bg-dcl-ruby/10 hover:border-dcl-ruby px-10 py-8 text-xl rounded-2xl transition-all duration-300 hover:scale-105 backdrop-blur-sm"
