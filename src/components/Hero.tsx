...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center px-4 pt-2 pb-6 overflow-hidden">
      <div className="relative z-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-white mb-6 md:mb-8 leading-tight animate-fade-in drop-shadow-2xl">
              Marketplace
          ...
          <div className="flex justify-center lg:justify-end items-center order-1 lg:order-2 animate-fade-in">
            <div className="relative">
              <img src="/lovable-uploads/2d2485d1-5a3d-4a90-89e0-5758004bf19c.png" alt="Decentraland Avatar with Shopping Bags" className="w-[900px] h-[900px] md:w-[1000px] md:h-[1000px] lg:w-[1100px] lg:h-[1100px] xl:w-[1200px] xl:h-[1200px] object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-300" />
