  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden">
      <div className="relative z-20 max-w-6xl mx-auto">
        ...
        <div className="inline-block px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-dcl-ruby/40 to-dcl-orange/40 rounded-full border-2 border-dcl-ruby/60 mb-6 md:mb-8 animate-fade-in backdrop-blur-md shadow-lg mx-auto block text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="bg-black/30 backdrop-blur-md rounded-2xl p-6 mb-8 md:mb-10 border border-white/20">
              <p className="text-lg md:text-2xl lg:text-3xl text-white mb-0 max-w-3xl mx-auto lg:mx-0 animate-fade-in leading-relaxed px-4 drop-shadow-lg font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center lg:justify-start items-center animate-fade-in mb-8 md:mb-12 px-4">
          ...
          {/* Right side - Avatar showcase */}
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative animate-fade-in">
              <div className="absolute inset-0 bg-gradient-to-r from-dcl-ruby via-dcl-orange to-dcl-yellow rounded-full blur-2xl opacity-30 scale-110"></div>
              <img 
                src="/lovable-uploads/d4ffae10-91da-4645-bd6a-48c74bf52b32.png" 
                alt="Decentraland Avatar with Shopping Credits" 
                className="relative z-10 w-80 h-80 md:w-96 md:h-96 lg:w-[500px] lg:h-[500px] object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500"
              />
            </div>
          </div>
        </div>
        ...
        {/* Stats section */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 text-center px-4 mt-12 lg:mt-16">
